...
Book.create!(title: 'Iron Man', editorial: 'Marvel', remote_photo_url: 'https://imagessl3.casadellibro.com/a/l/t0/93/9788415343493.jpg', user: u1)
Book.create!(title: 'Hulk', editorial: 'Marvel', remote_photo_url: 'http://marveldc.us/wp-content/uploads/images/1518267317-the-hulk-the-hulk-color-hulk-15-book.jpg', user: u1)
Book.create!(title: 'Batman', editorial: 'Justice League', remote_photo_url: 'https://larryfire.files.wordpress.com/2012/03/stk463102.jpg', user: User.find_by(name: 'Autor 2'))
Book.create!(title: 'Superman', editorial: 'Justice League', remote_photo_url: 'https://images-na.ssl-images-amazon.com/images/I/61V5f3tiDyL._SX374_BO1,204,203,200_.jpg', user: u2)
Book.create!(title: 'Flash', editorial: 'Justice League', remote_photo_url: 'http://webcovers.abramsbooks.com/cover_images/0/9781419728150_s3.jpg', user: u2)
Book.create!(title: 'Spiderman', editorial: 'Marvel', remote_photo_url: 'http://www.spiderfan.org/comics/images/spiderman_books_golden/meet.jpg', user: u2)
